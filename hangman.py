...
def getRandom_fruit():
    FRUITS = ['apple', 'banana', 'mango', 'strawberry', 'orange', 'grape', 'pineapple', 'apricot',
...
#def getRandom_animal():
    #ANIMALS = ['dog','cat','cow','lion','rat','elephant','zebra','leopard','tiger','turtle','rabbit','panda','cheetah','polar bear','donkey']
...
missedLetters = ''
correctLetters = ''
secretWord = getRandom_fruit()
#secretWord = getRandom_animal()
gameIsDone = False
